...
SKIP_SERVERS_IDS: [], // UUIDs of servers that you don't want to delete
SKIP_USERS: [], // IDs of users which you don't want to delete and you don't want to delete servers owned by them too
